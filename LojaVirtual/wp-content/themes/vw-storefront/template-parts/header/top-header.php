      ...
      <div class="row">
        <div class="col-lg-3 col-md-4">
          <?php if( get_theme_mod( 'vw_storefront_email_address') != '') { ?>
            <p><i class="fas fa-envelope"></i><a href="mailto:<?php echo esc_html(get_theme_mod('vw_storefront_email_address',''));?>"><?php echo esc_html(get_theme_mod('vw_storefront_email_address',''));?></a></p>
          <?php } ?>
        </div>
